...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{baby\_names }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\StringTok{"data/US\_Baby\_names/Baby\_Names\_By\_US\_State.rds"}\NormalTok{)}
\NormalTok{billboard }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\StringTok{"data/US\_Baby\_names/charts.rds"}\NormalTok{)}
\NormalTok{hbo\_titles }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\StringTok{"data/US\_Baby\_names/HBO\_titles.rds"}\NormalTok{)}
\NormalTok{hbo\_credits }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\StringTok{"data/US\_Baby\_names/HBO\_credits.rds"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
